...
class PlanetEyePlaceLinks {
	...
	function addMapScripts() {
		...
		if (!is_admin()) {
			...
			wp_enqueue_script("pe-injection", "http://alpha.planeteye.com:60200/contentmanagement/customers/wordpress/js/templates-referrer.aspx?customerId=" . get_option('pe_customer_id'), array(), '');
//			wp_enqueue_script("pe-injection", "http://demo.planeteye.com/contentmanagement/customers/wordpress/js/templates-referrer.aspx?customerId=" . get_option('pe_customer_id'), array(), '');
//			wp_enqueue_script("pe-injection", "http://www.planeteye.com/contentmanagement/customers/wordpress/js/templates-referrer.aspx?customerId=" . get_option('pe_customer_id'), array(), '');
