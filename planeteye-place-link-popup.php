                        ...
                        <div class="additionalbody">
                            <div class="col colleft">
                                <div>
                                    ...
                                    <input id="locationname" type="text" /></div>
                                <div>
                                    <div class="inlinelabel">Address:</div>
                                    <input id="locationaddress" type="hidden" /><span id="locationaddressLabel" class="latlng"></span></div>
                                <div>
                                    <div class="inlinelabel">Phone:</div>
                                    <input id="locationphone" type="text" /></div>
                                <div>
                                    <div class="inlinelabel">Website:</div>
                                    <input id="locationwebsite" type="text" /> <input id="locationwebsitecheckbox" type="checkbox" value="planeteye" checked style="width: 20px;" />Link to PlanetEye</div>
                                <div>
...
-->
                        ...
                        <div class="centerbuttons">
                            <div class="ssbus_create_button">
                                <!-- asp:HiddenField ID="HiddenFieldPlaceId" / -->
                                <!-- asp:HiddenField ID="HiddenFieldLatitude"  / -->
                                <!-- asp:HiddenField ID="HiddenFieldLongitude" / -->
